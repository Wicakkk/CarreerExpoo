<title>{{ $namePage ?? 'Login' }} | {{ config('app.name') }}</title>
@extends('layouts.app', [
    'namePage' => '',
    'class' => 'login-page sidebar-mini ',
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/bgpp.jpg",
    ])
@section('content')
<div class="content">
    <div class="container">
        ...
        <div class="col-md-5 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="logo-container">
                    <img src="{{ asset('assets/img/logopp.png') }}" alt="">
                </div>
                ...
                <div class="pull-left">
                    <h6 style="color: white; font-size:10px">Belum punya akun?   
                    <a href="{{ route('register') }}" class="link footer-link" style="color: #f96332">{{ __('Daftar Sekarang!') }}</a>
                    </h6>
                </div>
                </div>
            </div>
