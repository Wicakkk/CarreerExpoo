				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>PT. ALL QURRNY BAGAS PRATAMA</strong></h1>
							<p class="">Pt. All Qurrny Bagas Pratama adalah keagenan profesional yang berlisensi Kementerian Ketenagakerjaan dan terdaftar di BNP2MI  sebagai Perusahaan Penempatan Pekerja Migran Indonesia. Kami membantu pekerja TKI yang ingin bekerja di luar negeri, memfasilitasi proses mencari peluang kerja yang sesuai di luar negeri dan memberikan bimbingan dan dukungan sepanjang proses migrasi.
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/abp.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
			...
			<div class="modal-body">
			  ...
			  <div class="mb-3">
				...
				<select class="form-control" id="jenis_pekerjaan" aria-label="Default select example" name="jenis_pekerjaan">
				  <option value="Operation Manager">Option</option>
				</select>
			  </div>
			  <div class="mb-3">
