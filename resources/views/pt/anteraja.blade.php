...
<head>
    ...
    <!-- site metas -->
    <title>Career Expo | AnterAja</title>
                    ...
                    <div class="container">
                        <div class="row marginii">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <h1 class="mt-5"><strong>ANTERAJA</strong></h1>
							    <p class="">AnterAja menyediakan layanan jasa logistik yang menjangkau seluruh Indonesia dengan dukungan ekosistem yang lengkap. Sejak 2019, Anteraja telah tumbuh menjadi salah satu logistik terdepan di Indonesia yang mengintegrasi kemajuan teknologi dalam setiap layanan.
							    </p>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="mt-5">
                                    <figure>
                                        <img src="/images/anteraja.png" alt="img" style="max-width: 70%;">
                                    </figure>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="col-sm-12">
                ...
                <ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					...
					<h2><strong>1. Kurir barang</strong></h2>
				</ol>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="jenis_pekerjaan" aria-label="Default select example"
                            ...
                            <option value="Kurir Barang">Kurir Barang</option>
                        </select>
                    </div>
                    <div class="mb-3">
