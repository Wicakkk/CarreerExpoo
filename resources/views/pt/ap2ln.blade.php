...
<body>
				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>ASOSIASI PENYELENGGARA PEMAGANGAN LUAR NEGERI </strong></h1>
							<p class="">APPI Indonesia adalah Asosiasi Penyelenggara Pemagangan Indonesia yang memfasilitasi para User dari luar negeri untuk memakai SDM (Sumber Daya Manusia) dari Indonesia. Keunggulan APPI Indonesia ialah SDM yang akan direkrut oleh User Perusahaan Penerima dari Luar Negeri adalah SDM berkualitas yang telah siap untuk bekerja ke luar negeri. Dengan Motto “Indonesian Qualified Workforce, Go Global” yang artinya SDM Indonesia Go Global.
							</p>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/asosiasi.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
	...
	<div id="service" class="choose_section">
		<div class="container">
			<div class="col-sm-12">
				<h1 class="choose_text">Syarat &<span class="color"> Ketentuan</span></h1>
