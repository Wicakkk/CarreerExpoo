...
<!-- site metas -->
<title>Career Expo | Indivara Group</title>
...
<body>
				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>PT INDIVARA GROUP </strong></h1>
							<p class="">Indivara Group adalah salah satu perusahaan induk investasi teknologi terbesar di ASEAN dengan kehadiran signifikan di dua pasar terbesar; Indonesia dan Filipina. Berfokus pada dua divisi besar: Bisnis Enabler dan bisnis Platform. Produk dan layanan Indivara Group, antara lain pengembangan infrastruktur teknologi wealth management system, loyalty system, payment system, O2O Warung Platform, corporate travel management, dan IRIS enterprise support platform.
							</p>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/indivara.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="col-sm-12">
				...
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					...
					<h2><strong>1. Nama Pekerjaan</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>2. Nama Pekerjaan</strong></h2>
				</ol>
				Tertarik Dengan Perusahaan Kami!?
				<button type="button" class="register_button" data-bs-toggle="modal" data-bs-target="#contohModal">Daftar Sekarang</button> <ol></ol> <br>
			</div>
		</div>
	</div>
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			  ...
			  <div class="mb-3">
				...
				<select class="form-control" id="jenis_kelamin" aria-label="Default select example" name="jenis_kelamin">
			  ...
			  <div class="mb-3">
				...
				<input type="text" class="form-control" id="pendidikan_terakhir" placeholder="" name="pendidikan_terakhir" />
			  </div>
			  <div class="mb-3">
				<label for="jenis_pekerjaan" class="form-label"><b>Jenis Pekerjaan</b></label>
				<select class="form-control" id="jenis_pekerjaan" aria-label="Default select example" name="jenis_pekerjaan">
				  <option value="Option">Option</option>
				</select>
			  </div>
			  <div class="mb-3">
				<label for="id_perusahaan" class="form-label"><b>Perusahaan</b></label>
				<input type="text" class="form-control" id="id_perusahaan" placeholder="" name="id_perusahaan" />
			  </div>
			  <div class="mb-3">
				<label for="portfolio" class="form-label"><b>CV / Portfolio (Link Drive)</b></label>
				<input type="text" class="form-control" id="portfolio" placeholder="" name="portfolio" />
			  </div>
			</div>
    ...
    <div class="copyright_main">
    	<div class="container">
    		<p class="copy_text">© 2024 All Rights Reserved. <a href="https://prestasiprima.sch.id/">SMK PRESTASI PRIMA</a></p>
    	</div>
    </div>
