...
<head>
    ...
    <!-- site metas -->
    <title>Career Expo | Saham Rakyat</title>
				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>PT. Saham Rakyat </strong></h1>
							<p class="">Saham Rakyat adalah layanan yang disediakan oleh PT Saham Untuk Rakyat bagi para pengguna agar dapat mengenal, mempelajari hingga melakukan investasi secara online dengan mudah, namun tetap terjaga kerahasiaannya. Pengguna hanya perlu memberikan data atau informasi pribadi sesuai ketentuan yang diwajibkan oleh regulator, dimana informasi tersebut akan diolah secara transparan oleh Saham Rakyat untuk memudahkan kegiatan investasi.
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/saham1.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="col-sm-12">
				...
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					...
					<h2><strong>1. Back-end Developer</strong></h2>
