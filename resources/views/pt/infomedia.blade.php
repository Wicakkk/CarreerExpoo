				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>INFOMEDIA</strong></h1>
							<p class="">PT Infomedia Nusantara merupakan subsidiary PT Telkom Indonesia yang memfokuskan bisnisnya pada penyediaan solusi Business Process Outsourcing (BPO) melalui 2 portofolio bisnis, yaitu: Customer Relationship Management (CRM) dan Shared Service Operation (SSO). Hingga saat ini, kami telah mengelola proses bisnis dari 600 lebih perusahaan dari berbagai segmen industri. Dalam perjalanan bisnisnya, Infomedia menguasai 53% market share contact center, yang terus dikembangkan dengan mengadopsi teknologi digital terdepan untuk memastikan experience terbaik bagi pelanggan.
							</p>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/info.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
