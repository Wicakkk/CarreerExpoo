				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>PT. TRAPO INDONESIA </strong></h1>
							<p class="">Pt. Trapo Indonesia adalah perusahaan merek aksesoris otomotif terkemuka
								di Malaysia, Singapura, Thailand, dan Indonesia. Berkomitmen untuk mengubah limbah industri
								menjadi produk otomotif berkualitas tinggi yang berguna dan diinginkan oleh setiap pelanggan. <br> <br>
								Melalui kehadiran di beberapa negara Asia Tenggara, PT. Trapo Indonesia memainkan peran
								penting dalam mengubah cara orang melihat aksesoris otomotif.
							</p>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/trapo.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="col-sm-12">
                ...
                <ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					...
					<h2><strong>1. Content Spesialist</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>2. Online Sales Staff</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>3. Ofline Sales Staff</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>4. Marketing and Social Media Team</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>5. Production Admin Staff</strong></h2>
				</ol>
				<ol class="lorem_text" style="text-align: left; margin-bottom: 25px;">
					<h2><strong>6. Graphic Design Staff</strong></h2>
				</ol>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="jenis_pekerjaan" aria-label="Default select example"
                            ...
                            <option value="Content Spesialist">Content Spesialist</option>
                            <option value="Online Sales Staff">Online Sales Staff</option>
                            <option value="Ofline Sales Staff">Ofline Sales Staff</option>
                            <option value="Marketing and Social Media Team">Marketing and Social Media Team</option>
                            <option value="Production Admin Staff">Production Admin Staff</option>
                            <option value="Graphic Design Staff">Graphic Design Staff</option>
                        </select>
                    </div>
                    <div class="mb-3">
