				...
				<div class="container">
					<div class="row marginii">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<h1 class="mt-5"><strong>PRIMA FAJAR CAHAYA SURYA</strong></h1>
							<p class="">PT Prima Fajar Cahaya Surya adalah perusahaan agensi/outsourcing yang bergerak dibidang pemenuhan tenaga kerja, kami berpengalaman dalam pemenuhan tenaga kerja di dunia perbankan, e-commerce, logistik, sales dan manufacturing.
							</p>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="mt-5">
								<figure>
									<img src="/images/pfcs.png" alt="img" style="max-width: 100%;">
								</figure>
							</div>
						</div>
					</div>
